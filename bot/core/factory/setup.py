...
from bot.handlers import common, messages
from bot.middlewares import DBSessionMiddleware, ThrottlingMiddleware, UserManager, UserMiddleware
...
def setup_routers(dispatcher: Dispatcher) -> None:
    ...
    :param dispatcher: An instance of the Dispatcher for the Telegram bot.
    """
    dispatcher.include_routers(common.router, messages.router)
